...
// EVERY object in this game was MeshLambertMaterial: flat, matte, with NO SPECULAR
// TERM AT ALL. Lambert literally cannot catch the light. That's why things read as
// "shapes slapped together" no matter how much geometry went into them — they were
// shapes made of matte cardboard.
//
// A beach toy is injection-moulded plastic. It's SHINY. The hot little highlight
// where the sun catches it is what tells your eye the object is solid, curved and
// real — more than any amount of extra geometry ever will.
//
// Phong is still cheap forward shading. One line, and the whole game stops looking
// like paper craft.
export function plastic(color, opts = {}) {
  return new THREE.MeshPhongMaterial({
    color,
    specular: 0x6a6a6a,      // the plastic sheen
    shininess: 42,           // a tight, bright highlight — moulded ABS
    ...opts,
  });
}
