...
TRACKS.shingle = {
    hazardSpec: [
      { kind: "oil",  frac: 0.22, lat: 0.0, r: 3 },          // wet stone after the tide — narrowed: a line past it must always exist
...
TRACKS.pier = {
    ...
    hazardSpec: [
      { kind: "wave", frac: 0.12, lat: 0.0, r: 2.4, force: 4.5, side: 1 },
      { kind: "wave", frac: 0.38, lat: 0.0, r: 2.4, force: 4.5, side: -1 },
      { kind: "wave", frac: 0.62, lat: 0.0, r: 2.4, force: 5.5, side: 1 },
      { kind: "wave", frac: 0.86, lat: 0.0, r: 2.4, force: 5.5, side: -1 },
    ],
  id: "pier",
