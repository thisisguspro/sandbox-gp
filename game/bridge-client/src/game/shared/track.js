...
export const TRACKS = {
  sandcastle: {
    ...
    points: [
      ...
      { x: 30,   z: 54 },
      { x: 74,   z: 92 },
      { x: 140,  z: 74 },                      // swing back out east
      { x: 196,  z: 96 },
      { x: 120,  z: 124 },                     // back straight (westbound)
      { x: 0,    z: 130 },
      { x: -120, z: 126 },
      { x: -196, z: 96 },                      // west descent
      { x: -228, z: 40 },
      { x: -232, z: -20 },
      { x: -206, z: -74, y: 3.8 },             // bridge climb begins
      { x: -160, z: -106, y: 7.3 },            // climbing hard
      { x: -142, z: -116, y: 7.5 },            // ramp face steepens
      { x: -130, z: -124, y: 8.7 },            // KICKER — road ends at the straight's edge
      { x: -112, z: -156, y: 3.2 },            // touchdown ledge — kept HIGH so the
                                               // deck math never confuses it with
                                               // the straight it just cleared
      { x: -96,  z: -170, y: 0.6 },            // descent to the beach
      { x: -72,  z: -182, y: 0 },              // merge into the south sweep
      { x: -120, z: -222 },                    // southwest return
      { x: -204, z: -212 },
    ...
    gaps: [{ fromFrac: 0.8206, toFrac: 0.8374, kick: 0.07 }],
...
TRACKS.pharaoh = {
    hazardSpec: [
      ...
      { kind: "rockfall",  frac: 0.42, lat: 0.0, r: 4 },     // fallen masonry, dead centre
      { kind: "rockfall",  frac: 0.58, lat: -0.55, r: 4 },
    ],
  id: "pharaoh",
  ...
  elevation: [
    { frac: 0.42, y: -4.5, span: 0.07 },
    { frac: 0.68, y: 7.0, span: 0.06 },
  ],
};
...
TRACKS.shingle = {
  ...
  elevation: [
    { frac: 0.30, y: 5.0, span: 0.05 },   // over the breakwater
    { frac: 0.78, y: 3.5, span: 0.05 },
  ],
};
...
TRACKS.volcano = {
  ...
  elevation: [
    { frac: 0.30, y: 9.0, span: 0.07 },     // up the old flow
    { frac: 0.62, y: -3.5, span: 0.06 },    // down into the caldera cut
  ],
};
...
TRACKS.dunes = {
  ...
  elevation: [
    { frac: 0.22, y: 11.0, span: 0.06 },
    { frac: 0.50, y: 13.0, span: 0.06 },
    { frac: 0.84, y: 9.0, span: 0.05 },
  ],
};
