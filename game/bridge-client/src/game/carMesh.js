...
const toon = (color, opts = {}) => {
  const { transparent, opacity, side, emissive, emissiveIntensity, map, ...rest } = opts;
  return new THREE.MeshPhongMaterial({
    color,
    // THE PLASTIC SHEEN. A tight, bright highlight — the look of injection-moulded
    // ABS, which is what a beach toy is actually made of.
    specular: 0x6a6a6a,
    shininess: 42,
    flatShading: false,
