...
export default function Podium3D({ top3 = [], width = 460, height = 250 }) {
  ...
  useEffect(() => {
    ...
    for (const s of stepDefs) {
      ...
      // face the camera, near enough — each kart turned a little so you can see the
      // driver and the front of the car, not just its flank
      kart.rotation.y = Math.PI * 0.06;
