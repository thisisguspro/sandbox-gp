            ...
            <form onSubmit={doGuest} style={{ marginTop: googleOn ? 14 : 0 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <input value={guestName} onChange={(e) => setGuestName(e.target.value)} maxLength={20}
                  ...
                  style={{ flex: 1, padding: "10px 12px", borderRadius: 10, border: "1px solid var(--line)", background: "#fffdf6", color: "var(--paper)" }} />
...
const wrap = { height: "100%", position: "relative", display: "flex", flexDirection: "column", overflowY: "auto" };
