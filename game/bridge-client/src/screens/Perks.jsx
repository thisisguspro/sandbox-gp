...
export default function Perks({ profile, onAccountChange }) {
  ...
  return (
    <div style={{ padding: "32px 40px", height: "100%", overflowY: "auto" }}>
      ...
      <div className="display" style={{ fontSize: 40, color: "#fff", lineHeight: 0.95, marginTop: 2, textTransform: "uppercase" }}>Perk Garage</div>
          ...
          return (
            <button key={p.key} onClick={() => toggle(p.key, locked)}
              style={{
                ...
                background: on ? "linear-gradient(180deg, rgba(42,157,143,0.35), rgba(42,157,143,0.16))" : "rgba(0,0,0,0.28)",
