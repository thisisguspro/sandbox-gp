...
import { COVERED_BY_BODY } from "../components/IsoPilot.jsx";
    ...
    <div style={wrap}>
      ...
      <div style={{ position: "relative", zIndex: 2, height: "100%", display: "grid", gridTemplateColumns: "minmax(280px, 360px) 1fr" }}>
        ...
        <div style={previewCol}>
          ...
          <PilotPreview loadout={tryOn ? { ...loadout, [tryOn.slot]: tryOn.id } : loadout} catalogue={catalogue} emote={previewEmote} emoteNonce={emoteNonce} />
