...
export default function App() {
  ...
  return (
    // The app shell used to have `background: var(--ink)` — a SOLID CREAM FILL over
    // the whole viewport, sitting on top of the illustrated beach. The scene was
    // drawn into the body and then every pixel of it was covered by a flat colour.
