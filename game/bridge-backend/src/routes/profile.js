...
import { COSMETICS, SLOTS, SETS, LEVEL_UNLOCKS, xpForLevel, isCraftable, CRAFT_COST, scrapValue } from "../config/cosmetics.js";
...
profileRouter.get("/catalogue", (_req, res) => {
  res.json({
    ...
    // THE SETS. This is what makes the wardrobe a wardrobe instead of a pile of
    // hats. The research on cosmetic monetisation is blunt about it: "the clever
    // packaging of SETS of items appeals to players, making them want to purchase
    // the skin for their character AS WELL AS the accessories." A player who can
    // SEE that they're 9/11 of the way through the Lifeguard set has a reason to
    // open another chest. A player looking at 110 unrelated items has none.
