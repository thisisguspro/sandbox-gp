...
export const SLOTS = {
  ...
  weapon: { key: "weapon", label: "Kites", alwaysFilled: true, unlockLevel: 1, default: "tool_multitool" },
...
export const COSMETICS = {
  ...
  tank_jetpack:   { id: "tank_jetpack",   slot: "oxygenTank", set: "mecha",      name: "Twin-Jet Pack",      rarity: "Legendary", source: "premium" },
  ...
  // ---- THE NEW LINE (Spanky drop) ----
  head_propeller:   { id: "head_propeller",   slot: "headpiece", set: "sandcastle", name: "Propeller Beanie",    rarity: "Epic",      source: "premium" },
  head_chef:        { id: "head_chef",        slot: "headpiece", set: "sandcastle", name: "Boardwalk Toque",     rarity: "Rare",      source: "box" },
  head_cone:        { id: "head_cone",        slot: "headpiece", set: "sandcastle", name: "Little Cone",         rarity: "Common",    source: "starter" },
  head_headphones:  { id: "head_headphones",  slot: "headpiece", set: "neon",       name: "Beat Cans",           rarity: "Rare",      source: "box" },
  ...
  // ---- MIRROR KITES: the face only shows in your rivals' rear-view ----
  kite_eyes:      { id: "kite_eyes",      slot: "weapon", set: "sandcastle", name: "Peeper Kite",        rarity: "Common",    source: "box" },
  kite_clown:     { id: "kite_clown",     slot: "weapon", set: "neon",       name: "Grin Kite",          rarity: "Rare",      source: "box" },
  kite_shark:     { id: "kite_shark",     slot: "weapon", set: "surfpunk",   name: "Chomp Kite",         rarity: "Epic",      source: "premium" },
  ...
  shoes_wood:     { id: "shoes_wood",     slot: "shoes", set: "sandcastle", name: "Boardwalk Wagons", rarity: "Rare",      source: "box" },
...
export const LEVEL_UNLOCKS = {
  ...
  2: {
    ...
    grants: ["bandana_standard", "head_cap", "head_cone"],
